...
cat("Average video duration:", round(avg_duration, 1), "minutes", "\nLongest video duration:", max_duration, "minutes")

```

On average, I spend 22 minutes watching a YouTube videos, and the longest video I watched was 126 minutes.
...
From this analysis, I can see that the majority of my videos fall into the education category, reflecting a strong interest in learning and gaining knowledge. Additionally, most of the videos I watch are between 10-60 minutes long, indicating that I prefer content of a moderate length.
